...
class AdminGroup2Controller extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.admin_groups2.index', [
            'groups' => $groups,
        ]);
    }
    ...
    public function listing(Request $request)
    {
        ...
        return view('admin.admin_groups2._list', [
            'groups' => $groups,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.admin_groups2.create', [
            'group' => $group,
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            $request->session()->flash('alert-success', trans('messages.admin_group2.created'));

            return redirect()->action('Admin\AdminGroup2Controller@index');
        }
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.admin_groups2.edit', [
            'group' => $group,
            'permissions' => $permissions,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->isMethod('patch')) {
            ...
            $request->session()->flash('alert-success', trans('messages.admin_group2.updated'));

            return redirect()->action('Admin\AdminGroup2Controller@edit', $group->id);
        }
    }
