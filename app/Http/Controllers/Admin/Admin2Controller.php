...
class Admin2Controller extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.admins2.index', [
            'admins' => $admins,
        ]);
    }
    ...
    public function listing(Request $request)
    {
        ...
        return view('admin.admins2._list', [
            'admins' => $admins,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.admins2.create', [
            'admin' => $admin,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if ($admin->save()) {
                ...
                $request->session()->flash('alert-success', trans('messages.admin2.created'));

                return redirect()->action('Admin\Admin2Controller@index');
            }
        }
    }
    ...
    public function edit(Request $request, $id)
    {
        ...
        return view('admin.admins2.edit', [
            'admin' => $admin,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->isMethod('patch')) {
            ...
            if ($admin->save()) {
                $request->session()->flash('alert-success', trans('messages.admin2.updated'));
                return redirect()->action('Admin\Admin2Controller@index');
            }
        }
    }
