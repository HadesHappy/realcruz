...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <form enctype="multipart/form-data" action="{{ action('Admin\TemplateController@uploadTemplate') }}" method="POST" class="ajax_upload_form form-validate-jquery">
                {{ csrf_field() }}
                ...
                <div class="text-end">
                    ...
                    <a href="{{ action('Admin\TemplateController@index') }}" class="btn btn-link"><i class="icon-cross2"></i> {{ trans('messages.cancel') }}</a>
                </div>
