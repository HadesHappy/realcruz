...
@section('content')
    <form id="classic-builder-form" action="{{ action('Admin\TemplateController@update', $template->uid) }}" method="POST" class="ajax_upload_form form-validate-jqueryz builder-classic-form">
        {{ csrf_field() }}
