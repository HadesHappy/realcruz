    ...
    <div class="page-title">
        ...
        <h1>
            <span class="text-semibold"><span class="material-symbols-rounded">
                ...
                </span> {{ trans('messages.admin_groups') }}</span>
        </h1>
    </div>
...
search
            ...
            @can('create', new Acelle\Model\AdminGroup())
                <div class="text-end">
                    <a href="{{ action("Admin\AdminGroupController@create") }}" role="button" class="btn btn-secondary">
                        <span class="material-symbols-rounded">
add
    ...
    <script>
        var AdminGroupsIndex = {
            getList: function() {
                return makeList({
                    url: '{{ action('Admin\AdminGroupController@listing') }}',
