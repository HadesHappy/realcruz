...
@section('content')
    <form id="classic-builder-form" action="{{ action('TemplateController@update', $template->uid) }}" method="POST" class="ajax_upload_form form-validate-jquery builder-classic-form">
        {{ csrf_field() }}
