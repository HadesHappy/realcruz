...
search
            ...
            <div class="text-end">
                <a href="javascript:goToDownLoad('tracking_logs')" role="button" class="btn btn-secondary">
                    <i class="icon icon-download me-1"></i> {{ trans('messages.tracking_log.download') }}
                </a>
            </div>
        </div>
