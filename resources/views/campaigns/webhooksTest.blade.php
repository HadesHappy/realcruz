...
@section('content')
    <form class="test-webhook-form" action="{{ action('CampaignController@webhooksTest', [
    ...
    <script>
        var CampaignsWebhooksTest = {
            save: function() {
                ...
                $.ajax({
                    ...
                    CampaignsWebhooksList.getTestPopup().loadHtml(response);
                }).fail(function(jqXHR, textStatus, errorThrown){
                    CampaignsWebhooksList.getTestPopup().loadHtml(jqXHR.responseText);
                }).always(function() {
        ...
        $(function() {
            ...
            $('.edit-webhook2').on('click', function(e) {
                ...
                CampaignsWebhooksList.getTestPopup().hide();
