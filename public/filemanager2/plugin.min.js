...
tinymce.PluginManager.add('filemanager', function(editor) {
	...
	function filemanager(callback, value, meta) {
		...
		var dialogUrl = editor.settings.external_filemanager_path+'dialog.php?type=2&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.settings.language+'&akey='+akey;
